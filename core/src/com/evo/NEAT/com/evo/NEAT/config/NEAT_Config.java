...
public class NEAT_Config {
    ...
    public static final int INPUTS = GenomeSensorSystem.HEIGHT*GenomeSensorSystem.WIDTH;
    ...
    public static final float STALE_SPECIES = 3;
    ...
    public static final int STALE_POOL = 50;
}
